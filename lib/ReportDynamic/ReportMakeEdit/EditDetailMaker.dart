...
// MODIFIED: Added controller for the unique code
  ...
  void initState() {
    ...
    for (var controller in [
      ...
      _apiController,
// MODIFIED: Added ucode controller to listener group
      _ucodeController,
    ]) {
...
// MODIFIED: Dispose of the ucode controller
      ...
      child: Scaffold(
        ...
        body: BlocListener<EditDetailMakerBloc, EditDetailMakerState>(
          listener: (context, state) {
            // MODIFIED: Update ucode controller from state
            if (_ucodeController.text != (state.ucode ?? '')) {
              _ucodeController.text = state.ucode ?? '';
            }
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          const SizedBox(width: 16),
// MODIFIED: Added Unique Code field
                                          Expanded(
                                            child: _buildTextField(
